...
//        Arguments
        ...
        argument = new Argument();
        argument.setAuthor(user);
        argument.setTitle("Les arabes devraient partir de notre pays");
        argument.setDescription("Les arabes devraient partir de notre pays car ils sont dangereux et ils ne respectent pas les lois de notre pays.");
